        ...
        <div className="lg:px-12 px-4 flex flex-col md:flex-row-reverse items-center justify-between  gap-4">
          ...
          <div className="md:w-1/2 w-full ">
            ...
            <p className="text-2xl text-body leading- mb-8">
              My designs blend creativity and functionality, capturing the
              essence of each project. From front-end magic with React to
              back-end wizardry with Node.js, I bring ideas to life. 📚 I m a
            ...
            <div className=" flex  flex-wrap items-center gap-y-4 ml-1 gap-x-8">
              ...
              <a
                href="/personal-portfolio/src/assets/exjs.jpg"
